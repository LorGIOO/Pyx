...
function buildLatexDeco(view) {
  ...
  // Lines covered by Python cells (skipped here — the Python overlay owns them).
  // Bisect rather than scan: this runs once per visible line, and a linear
  // `.some()` over the cell list turned that into O(visible × cells).
