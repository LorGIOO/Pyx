...
%#python
# La API real de handcalcs, importada por el documento. `handcalc()` es un
# decorador que devuelve (latex, resultado); lo envolvemos para insertarlo
# con \py{} como display math.
import pint
...
def hc(func, *args, **kwargs):
    out = handcalc(jupyter_display=False)(func)(*args, **kwargs)
